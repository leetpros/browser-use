...
save_screenshots_path = "./task_stylo_product_size-guide"

url = "https://www.stylo.pk/"
...
async def main():
    ...
    agent = Agent(
        task=f"Navigate to {url}, search for shoes, pick first product and check the size guide.",
        llm=llm,
        save_screenshots_path=save_screenshots_path,
        browser=browser,
