...
save_screenshots_path = "./task_insignia_product_images"
...
async def main():
    ...
    agent = Agent(
        task=f"Navigate to {url}, perform a search for a product, select a product from the results, open all the product images.",
        llm=llm,
