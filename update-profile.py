...
save_screenshots_path = "./task_screenshots_domexa_update_profile"
...
async def main():
    ...
    agent = Agent(
        task="Goto https://app.domexa.cloud and login with name and password. And perform update profile like change name and update profile picture (if option available)",
        llm=llm,
