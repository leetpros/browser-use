...
save_screenshots_path = "./task_insignia_product_checkout"
...
async def main():
    ...
    agent = Agent(
        task=f"Navigate to {url}, search for product and perform checkout. Just fill out the checkout form. No need to submit that form.",
        llm=llm,
        save_screenshots_path=save_screenshots_path,
        browser=browser,
