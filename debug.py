...
sensitive_data={ "name": "testadmin2", "password": "hashedpassword123"}

save_screenshots_path = "./task_screenshots_domexa"
...
async def main():
    ...
    agent = Agent(
        task="Goto https://app.domexa.cloud and login with name and password and no need to unhide the password.",
        llm=llm,
